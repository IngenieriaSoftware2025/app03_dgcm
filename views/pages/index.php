  ...
  <div class="col-12">
    <div class="bg-white rounded-3 p-4 shadow-sm border-0">
      <div class="row align-items-center">
        <div class="col-lg-8">
          <h2 class="fw-bold text-dark mb-2">¡Bienvenido al Sistema CIT!</h2>
          <p class="text-muted mb-3 fs-5">Gestiona aplicaciones, permisos y usuarios desde un solo lugar</p>
          <p class="text-secondary">Sistema de gestión integral del Comando de Informática y Tecnología</p>
        </div>
...
<div class="row g-3 mb-5">
  <?php if (isset($_SESSION['user'])): ?>
    ...
    <div class="col-md-6 col-lg-3">
      <a href="/app03_carbajal_clase/aplicaciones" class="text-decoration-none">
    ...
    <!-- Permisos -->
    <div class="col-md-6 col-lg-3">
      <a href="/app03_carbajal_clase/permisos" class="text-decoration-none">
        <div class="bg-white rounded-3 p-4 h-100 shadow-sm border-0 hover-card">
          <div class="text-center">
            <div class="mb-3">
    ...
    <!-- Usuarios -->
    <div class="col-md-6 col-lg-3">
      <a href="/app03_carbajal_clase/registro" class="text-decoration-none">
        <div class="bg-white rounded-3 p-4 h-100 shadow-sm border-0 hover-card">
          <div class="text-center">
            <div class="mb-3">
    ...
    <!-- Asignaciones -->
    <div class="col-md-6 col-lg-3">
      <a href="/app03_carbajal_clase/asignacion_permisos" class="text-decoration-none">
        <div class="bg-white rounded-3 p-4 h-100 shadow-sm border-0 hover-card">
          <div class="text-center">
            <div class="mb-3">
  ...
  <?php else: ?>
    <!-- Login -->
    <div class="col-md-6">
      <a href="/app03_carbajal_clase/login" class="text-decoration-none">
