...
const cargarUsuarios = async () => {
    try {
        const resp = await fetch('/app03_carbajal_clase/busca_usuario');
...
const buscaAsignaciones = async () => {
    try {
        const resp = await fetch('/app03_carbajal_clase/busca_asig_permiso');
        const datos = await resp.json();
...
const guardaAsignacion = async (e) => {
    ...
    const resp = await fetch('/app03_carbajal_clase/guarda_asig_permiso', { method: 'POST', body });
    const datos = await resp.json();
...
const modificaAsignacion = async (e) => {
    ...
    const body = new FormData(FormAsigPermisos);
    const resp = await fetch('/app03_carbajal_clase/modifica_asig_permiso', { method: 'POST', body });
    const datos = await resp.json();
...
const eliminaAsignacion = async (e) => {
    ...
    const resp = await fetch('/app03_carbajal_clase/elimina_asig_permiso', { method: 'POST', body });
    const datos = await resp.json();
